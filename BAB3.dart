...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "profession": "Penulis",
      "rating": 4.9,
      "image": "assets/images/agatha.jpeg"
    },
    {
      "name": "Tan Malaka",
      "profession": "Penulis",
      "rating": 4.9,
      "image": "assets/images/malaka.jpeg"
    },
    {
      "name": "JK Rowling",
      "profession": "Penulis",
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/agatha.jpeg',
          name: 'Agatha C',
          role: 'Penulis',
        ...
        ServiceCard(
          imageUrl: 'assets/images/malaka.jpeg',
          name: 'Tan Malaka',
          role: 'Penulis',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
    ...
    return Column(
        children: [
          BestBookingCard(
            ...
            profileUrl: 'assets/images/agatha.jpeg',
